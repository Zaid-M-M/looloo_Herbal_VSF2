...
export default defineComponent({
  ...
  setup() {
    ...
    const { toggleCartSidebar, toggleWishlistSidebar, toggleLoginModal , isLoginModalOpen } = useUiState();
...
.menubar .header-navigation a:hover{
  color:#05923f ;
}
...
.menubar .sf-header-navigation-item__item a:nth-last-child(2) {
    display: none;
} */
