<template>
  <SfTabs
    ...
    @click:tab="changeTab"
  >
    <SfTab :title="$t('Key Ingredients')">
      <div v-if="keyIngredients" v-html="keyIngredients" class="product__key-ingredients"></div>
    </SfTab>
    <SfTab :title="$t('Benefits')">
      <div v-if="benefits" v-html="benefits" class="product__key-ingredients"></div>
    </SfTab>
    <SfTab :title="$t('Method od Use')">
      <div v-if="method_of_use" v-html="method_of_use" class="product__key-ingredients"></div>
    </SfTab>
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const keyIngredients = computed(() => DOMPurify.sanitize(props.keyIngredients));
    const benefits = computed(() => DOMPurify.sanitize(props.benefits));
    const method_of_use = computed(() => DOMPurify.sanitize(props.method_of_use));
