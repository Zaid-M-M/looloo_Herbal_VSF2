...
export interface ProductGetters {
  ...
  getProductKey_ingredients(product: ProductInterface): string;
...
export const getProductKey_ingredients = (product: Product): string => product.key_ingredients;
