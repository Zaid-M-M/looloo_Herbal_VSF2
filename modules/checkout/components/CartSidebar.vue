        ...
        <transition name="sf-fade">
          <div v-if="totalItems">
            ...
            <div class="sf-property--full-width sf-property--small sf-property">
              <span class="sf-property__name" v-for="(d, index) in discount" :key="index">{{ d.name }}</span>
...
#cart .sf-collected-product.collected-product {
  border-bottom: 1px solid #dddddd;
}
#cart .sf-collected-product__details a {
  font-family: "Montserrat";
  font-size: 14px;
  margin: 0 0 5px;
}
#cart span.sf-price__regular {
  font-family: "Montserrat";
  font-size: 16px;
}
#cart span.sf-collected-product__image {
  width: 89%;
}
#cart span.sf-collected-product__image img {
  width: 100%;
}
#cart .sf-collected-product__quantity-selector.sf-quantity-selector {
  height: 38px;
  border-radius: 50px;
  border: 1px solid #c7ba62;
  background: #f5f1dd;
  color: #a17b20;
}
#cart .sf-quantity-selector__button {
  font-family: "Montserrat";
  margin-top: -2px;
  font-size: 17px;
  color: #a17b20;
}
#cart .sf-input__wrapper input {
  font-family: "Montserrat";
  color: #a17b20;
  font-weight: 500;
  font-size: 17px;
...
.sf-collected-product__configuration .sf-property {
  flex-direction: column;
}
.sf-collected-product__configuration .sf-property span {
  font-size: 14px;
  font-weight: 400;
}
.sf-collected-product__configuration .sf-property span:first-child {
  font-weight: 500;
}
