...
export default defineComponent({
  ...
  setup() {
    ...
    onMounted(async () => {
      ...
      // console.log('Billing Address Region Code:', cart.value?.billing_address?.region?.code);
      if (cart.value?.billing_address?.region?.code === 'MH') {
        console.log('In Maha');
...
th ,  td , td div span , .summary span{
