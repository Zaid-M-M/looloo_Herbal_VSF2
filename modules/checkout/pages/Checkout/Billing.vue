  ...
  setup() {
    ...
    const handleCheckSameAddress = async (value: boolean) => {
      ...
      if (value) {
        ...
        //console.log('Region code:', shippingDetails.value.region.code);
        if (shippingDetails.value.region.code === 'MH') {
          console.log('In Maha');
    ...
    onMounted(async () => {
      ...
      // Check and log if the region value is "MH"
      //console.log('Current region value:', billingDetails.value?.region);
      // if (billingDetails.value?.region === 'MH') {
      //   console.log('Billign Region value is MH');
      // }
